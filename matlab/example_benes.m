...
% Simulate
[xx, ff, LL, QQ, dt_sym, X, x0] = models.benes(T, dt, 1000);
for i = 1:size(Y, 2)
...
plot(X, 'LineWidth',2, 'Color', [0 0.4470 0.7410], ...
                        'DisplayName', 'True mean');
hold on
plot(MM, 'LineWidth',2, 'Color', [0.9290 0.6940 0.1250], ...
                        'DisplayName', 'TME Filtering mean');
plot(MS, 'LineWidth',2, 'Color', [0.8500 0.3250 0.0980], ...
...
save('tme_benes_filter_smoother.mat', 'TT', 'X', 'Y', 'MM', 'PP', 'MS', 'PS')